<template>
  <div class="app-container">
    <div class="block">
      ...
      <!--课程评分表格-->
      <el-table :data="courseScoreList" border style="width: 100%">
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      this.httpPost("/video/courseScore/list", param).then(res => {
        this.courseScoreList = res.data.data;
