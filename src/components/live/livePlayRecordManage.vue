<template>
  <div class="app-container">
    <div class="block">
      ...
      <!--直播播放记录表格-->
      <el-table :data="livePlayRecordList" border style="width: 100%">
  ...
  export default {
    ...
    methods: {
      ...
      loadData() {
        ...
        this.httpPost("/live/livePlayRecord/list", param).then((res) => {
          this.livePlayRecordList = res.data.data;
