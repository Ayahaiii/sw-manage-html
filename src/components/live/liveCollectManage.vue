<template>
  <div class="app-container">
    <div class="block">
      ...
      <!--直播收藏表格-->
      <el-table :data="liveCollectList" border style="width: 100%">
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      this.httpPost("/live/liveCollect/list", param).then(res => {
        this.liveCollectList = res.data.data;
